...
export const signUp = user => axios.post(process.env.REACT_APP_API_URL + "/auth-owner/signup", user);

export const signIn = user => axios.post(process.env.REACT_APP_API_URL + "/auth-owner/signin", user);

export const refreshToken = id =>
  axios.post(process.env.REACT_APP_API_URL + "/auth-owner/refreshToken", { _id: id });
